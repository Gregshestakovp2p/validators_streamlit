...
operator_select=st.selectbox(
        ...
        ["Blockscape","P2P.ORG - P2P Validator","DSRV","stakefish","Staking Facilities","Allnodes","RockX","Kiln","ChainLayer","BridgeTower","Chorus One","Figment","Simply Staking","InfStones","Everstake","Stakin","Stakely","HashQuark","Blockdaemon","Anyblock Analytics","ConsenSys Codefi","Certus One","CryptoManufaktur - Lido","Kukis Global","RockLogic GmbH","Nethermind - Lido","Sigma Prime - Lido","ChainSafe - Lido"]
    )
